...
Jump to [our release page](https://github.com/nativeit-dev/tacoscript/releases/tag/latest) and download a binary
...
```shell
git clone https://github.com/nativeit-dev/tacoscript.git
cd tacoscript
